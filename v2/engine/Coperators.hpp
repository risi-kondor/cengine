...
class Coperator1 : public Coperator {
 public:
  Coperator1(Cnode* x0) { inputs.push_back(x0); }
  ...
  RET& output() { return dynamic_cast<RET&>(*owner->obj); }

  void exec() { exec(dynamic_cast<OBJ0&>(*inputs[0]->obj)); }
...
class CumulativeOp2 : public Coperator,
 ...
 public:
  ...
  OBJ0& output() { return dynamic_cast<OBJ0&>(*owner->obj); }
...
class CumulativeOp3 : public Coperator,
                      public InPlaceOperator,
                      public CumulativeOperator {
 public:
...
class CumulativeOp4 : public Coperator,
                      public InPlaceOperator,
                      public CumulativeOperator {
 public:
