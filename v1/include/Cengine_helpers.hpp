...
class _pullin {
 public:
  ...
  _pullin(const TYPE& _obj) : obj(const_cast<TYPE&>(_obj)) {
    dev = obj.dev;
    obj.to_device(0);
  }
  ~_pullin() { obj.to_device(dev); }
};
...
class pullin2 {
 public:
  ...
  pullin2(const TYPE& _obj0, const TYPE& _obj1)
      : obj0(const_cast<TYPE&>(_obj0)), obj1(const_cast<TYPE&>(_obj1)) {
    device0 = obj0.device;
    device1 = obj1.device;
    obj0.to_device(0);
    obj1.to_device(0);
