...
Chandle* new_cscalar_set(const complex<float> x,
                         const int nbd = -1,
                         const int device = 0) {
...
Chandle* cscalar_add_times_real(Chandle* r, Chandle* x, float c) {
  return Cengine_engine->push<cscalar_add_times_real_op>(nodeof(r), nodeof(x),
                                                         c);
}

Chandle* cscalar_add_times_complex(Chandle* r, Chandle* x, complex<float> c) {
  return Cengine_engine->push<cscalar_add_times_complex_op>(nodeof(r),
                                                            nodeof(x), c);
}
...
Chandle* cscalar_add_prod(Chandle* r, Chandle* x, Chandle* y) {
  return Cengine_engine->push<cscalar_add_prod_op>(nodeof(r), nodeof(x),
                                                   nodeof(y));
}

Chandle* cscalar_add_prodc(Chandle* r, Chandle* x, Chandle* y) {
  return Cengine_engine->push<cscalar_add_prodc_op>(nodeof(r), nodeof(x),
                                                    nodeof(y));
}

Chandle* cscalar_add_prod_r(Chandle* r, Chandle* x, Chandle* y) {
  return Cengine_engine->push<cscalar_add_prod_r_op>(nodeof(r), nodeof(x),
                                                     nodeof(y));
}

Chandle* cscalar_add_div(Chandle* r, Chandle* x, Chandle* y) {
  return Cengine_engine->push<cscalar_add_div_op>(nodeof(r), nodeof(x),
                                                  nodeof(y));
}

Chandle* cscalar_add_div_back0(Chandle* r, Chandle* g, Chandle* y) {
  return Cengine_engine->push<cscalar_add_div_back0_op>(nodeof(r), nodeof(g),
                                                        nodeof(y));
}

Chandle* cscalar_add_div_back1(Chandle* r, Chandle* g, Chandle* x, Chandle* y) {
  return Cengine_engine->push<cscalar_add_div_back1_op>(nodeof(r), nodeof(g),
                                                        nodeof(x), nodeof(y));
}
...
Chandle* cscalar_add_abs_back(Chandle* r, Chandle* g, Chandle* x) {
  return Cengine_engine->push<cscalar_add_abs_back_op>(nodeof(r), nodeof(g),
                                                       nodeof(x));
}
...
Chandle* cscalar_add_ReLU_back(Chandle* r,
                               Chandle* g,
                               Chandle* x,
                               const float c) {
  return Cengine_engine->push<cscalar_add_ReLU_back_op>(nodeof(r), nodeof(g),
                                                        nodeof(x), c);
}
...
Chandle* cscalar_add_sigmoid_back(Chandle* r, Chandle* g, Chandle* x) {
  return Cengine_engine->push<cscalar_add_sigmoid_back_op>(nodeof(r), nodeof(g),
                                                           nodeof(x));
}
