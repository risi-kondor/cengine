...
class RscalarObject {
 ...
 public
     :  // ---- Filled constructors
        // ------------------------------------------------------------------------
  RscalarObject() { hdl = (*Cengine_engine)(new new_rscalar_op(-1, 0)); }
 ...
 public
  ...
  RscalarObject plus(const RscalarObject& x) {
    return RscalarObject(
        (*Cengine_engine)(new rscalar_add_op(nodeof(hdl), nodeof(x.hdl))));
  }
 ...
 public
  ...
  void add(const RscalarObject& x, const float c) {
    replace(hdl, (*Cengine_engine)(new rscalar_add_times_real_op(
                     nodeof(hdl), nodeof(x.hdl), c)));
  }
  ...
  void subtract(const RscalarObject& x) {
    replace(hdl, (*Cengine_engine)(
                     new rscalar_subtract_op(nodeof(hdl), nodeof(x.hdl))));
  }
  ...
  void add_minus(const RscalarObject& x, const RscalarObject& y) {
    replace(hdl,
            (*Cengine_engine)(new rscalar_add_op(nodeof(hdl), nodeof(x.hdl))));
    replace(hdl, (*Cengine_engine)(
                     new rscalar_subtract_op(nodeof(hdl), nodeof(y.hdl))));
  }

  void add_prod(const RscalarObject& x, const RscalarObject& y) {
    replace(hdl, (*Cengine_engine)(new rscalar_add_prod_op(
                     nodeof(hdl), nodeof(x.hdl), nodeof(y.hdl))));
  }
  ...
  void add_div(const RscalarObject& x, const RscalarObject& y) {
    replace(hdl, (*Cengine_engine)(new rscalar_add_div_op(
                     nodeof(hdl), nodeof(x.hdl), nodeof(y.hdl))));
  }

  void add_div_back0(const RscalarObject& g, const RscalarObject& y) {
    replace(hdl, (*Cengine_engine)(new rscalar_add_div_back0_op(
                     nodeof(hdl), nodeof(g.hdl), nodeof(y.hdl))));
  }

  void add_div_back1(const RscalarObject& g,
                     const RscalarObject& x,
                     const RscalarObject& y) {
    replace(hdl,
            (*Cengine_engine)(new rscalar_add_div_back1_op(
                nodeof(hdl), nodeof(g.hdl), nodeof(x.hdl), nodeof(y.hdl))));
  }

  void add_abs(const RscalarObject& x) {
    replace(hdl, (*Cengine_engine)(
                     new rscalar_add_abs_op(nodeof(hdl), nodeof(x.hdl))));
  }

  void add_abs_back(const RscalarObject& g, const RscalarObject& x) {
    replace(hdl, (*Cengine_engine)(new rscalar_add_abs_back_op(
                     nodeof(hdl), nodeof(g.hdl), nodeof(x.hdl))));
  }
  ...
  void add_pow(const RscalarObject& x, const float p, const float c = 1.0) {
    replace(hdl, (*Cengine_engine)(
                     new rscalar_add_pow_op(nodeof(hdl), nodeof(x.hdl), p, c)));
  }

  void add_exp(const RscalarObject& x) {
    replace(hdl, (*Cengine_engine)(
                     new rscalar_add_exp_op(nodeof(hdl), nodeof(x.hdl))));
  }

  void add_ReLU(const RscalarObject& x, const float c = 0) {
    replace(hdl, (*Cengine_engine)(
                     new rscalar_add_ReLU_op(nodeof(hdl), nodeof(x.hdl), c)));
  }

  void add_ReLU_back(const RscalarObject& g,
                     const RscalarObject& x,
                     const float c = 0) {
    replace(hdl, (*Cengine_engine)(new rscalar_add_ReLU_back_op(
                     nodeof(hdl), nodeof(g.hdl), nodeof(x.hdl), c)));
  }

  void add_sigmoid(const RscalarObject& x) {
    replace(hdl, (*Cengine_engine)(
                     new rscalar_add_sigmoid_op(nodeof(hdl), nodeof(x.hdl))));
  }

  void add_sigmoid_back(const RscalarObject& g, const RscalarObject& x) {
    replace(hdl, (*Cengine_engine)(new rscalar_add_sigmoid_back_op(
                     nodeof(hdl), nodeof(g.hdl), nodeof(x.hdl))));
  }
 ...
 public:
  ...
  void norm2_into(RscalarObject& R) const { R.add_prod(*this, *this); }

 public
     :  // ---- I/O
        // ----------------------------------------------------------------------------------------
  string classname() const { return "GEnet::RscalarObject"; }
...
inline RscalarObject& asRscalar(Dobject* x){
  ...
  if(!dynamic_cast<RscalarObject*>(x))
    cerr<<"GEnet error: Dobject is of type "<<x->classname()<<" instead of
RscalarObject."<<endl; assert(dynamic_cast<RscalarObject*>(x)); return
static_cast<RscalarObject&>(*x);
}
...
inline RscalarObject& asRscalar(Dnode* x){
  ...
  if(!dynamic_cast<RscalarObject*>(x->obj))
    cerr<<"GEnet error: Dobject is of type "<<x->obj->classname()<<" instead of
RscalarObject."<<endl; assert(dynamic_cast<RscalarObject*>(x->obj)); return
static_cast<RscalarObject&>(*x->obj);
}
