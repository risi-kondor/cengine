...
/*
class ctensorarray_add_conj_op: public Coperator, public CumulativeOperator,
...
/*
class ctensorarray_add_transp_op: public Coperator, public CumulativeOperator,
public InPlaceOperator{ public:
...
/*
class ctensorarray_add_herm_op: public Coperator, public CumulativeOperator,
public InPlaceOperator{ public:
...
/*
class ctensorarray_add_sum_op: public Coperator, public CumulativeOperator,
public InPlaceOperator{ public:
...
/*
class ctensorarray_add_to_slice_op: public Coperator, public CumulativeOperator,
public InPlaceOperator{ public:

  int ix;
  int offs;

  ctensorarray_add_to_slice_op(Cnode* r, Cnode* x, const int _ix, const int
_offs): Coperator(r,x), ix(_ix), offs(_offs){}
...
/*
class ctensorarray_add_to_chunk_op: public Coperator, public CumulativeOperator,
public InPlaceOperator{ public:

  int ix;
  int offs;

  ctensorarray_add_to_chunk_op(Cnode* r, Cnode* x, const int _ix, const int
_offs): Coperator(r,x), ix(_ix), offs(_offs){}
...
/*
class ctensorarray_add_to_slices_op: public Coperator, public
CumulativeOperator, public InPlaceOperator{ public:
...
/*
class ctensorarray_add_slice_op: public Coperator, public CumulativeOperator,
public InPlaceOperator{ public:
...
/*
class ctensorarray_add_chunk_op: public Coperator, public CumulativeOperator,
public InPlaceOperator{ public:
  ...
  ctensorarray_add_chunk_op(Cnode* r, Cnode* x, const int _ix, const int _offs,
const int _n): Coperator(r,x), ix(_ix), offs(_offs), n(_n){}
...
class ctensorarray_subtract_op : public Coperator,
                                 public CumulativeOperator,
                                 public InPlaceOperator {
 public:
  ctensorarray_subtract_op(Cnode* r, Cnode* x) : Coperator(r, x) {}
  ...
  string str() const { return "ctensorarray_subtract" + inp_str(); }
};

// ---- Products
// -------------------------------------------------------------------------------------------

class ctensorarray_add_times_realarray_op : public Coperator,
                                            public CumulativeOperator,
                                            public InPlaceOperator {
 public:
  float c;
  ...
  string str() const { return "ctensorarray_add_times_realarray" + inp_str(); }
};

class ctensorarray_add_times_complexarray_op : public Coperator,
                                               public CumulativeOperator,
                                               public InPlaceOperator {
 public:
  complex<float> c;
  ...
  string str() const { return "ctensorarray_add_teims_complex" + inp_str(); }
};

/*
class ctensorarray_add_prod_r_A_op: public Coperator, public CumulativeOperator,
public InPlaceOperator{ public:
...
/*
class ctensorarray_add_prod_cc_A_op: public Coperator, public
CumulativeOperator, public InPlaceOperator{ public:
...
/*
class ctensorarray_add_prod_c_Ac_op: public Coperator, public
CumulativeOperator, public InPlaceOperator{ public:
...
class ctensorarray_add_ReLU_op : public Coperator,
                                 public CumulativeOperator,
                                 public InPlaceOperator {
 public:
  float c = 0;
  ...
  string str() const { return "ctensorarray_add_ReLU" + inp_str(); }
};

class ctensorarray_add_ReLU_back_op : public Coperator,
                                      public CumulativeOperator,
                                      public InPlaceOperator {
 public:
  float c = 0;
  ...
  string str() const { return "ctensorarray_add_ReLU_back" + inp_str(); }
};

/*
class ctensorarray_add_element_op: public Coperator, public CumulativeOperator,
public InPlaceOperator{ public:
...
class ctensorarray_add_to_element_op: public Coperator, public
CumulativeOperator, public InPlaceOperator{ public:
