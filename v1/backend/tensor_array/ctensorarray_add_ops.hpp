...
class ctensorarray_add_op : public Coperator,
                            public CumulativeOperator,
                            public InPlaceOperator {
 public:
  ctensorarray_add_op(Cnode* r, Cnode* x) : Coperator(r, x) {}
 ...
 public:
  string str() const { return "ctensorarray_add" + inp_str(); }

  static string classname() { return "ctensorarray_add_op"; }
};

class ctensorarray_add_prod_c_A_op : public Coperator,
                                     public CumulativeOperator,
                                     public InPlaceOperator {
 public:
 ...
 public:
  ...
  static string classname() { return "ctensorarray_add_prod_c_A_op"; }
};
