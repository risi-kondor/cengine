...
class new_ctensorarray_op : public Coperator {
 public:
  ...
  new_ctensorarray_op(const Gdims& _adims,
                      const Gdims& _dims,
                      const int _nbu = -1,
                      const int _device = 0)
  ...
  string str() const { return "new_ctensorarray" + adims.str() + dims.str(); }
};
...
class new_ctensorarray_zero_op : public Coperator {
 public:
  ...
  new_ctensorarray_zero_op(const Gdims& _adims,
                           const Gdims& _dims,
                           const int _nbu = -1,
                           const int _device = 0)
      : adims(_adims), dims(_dims), nbu(_nbu), device(_device) {}
  ...
  string str() const { return "ctensorarray_zero" + adims.str() + dims.str(); }
};
...
class new_ctensorarray_ones_op : public Coperator {
 public:
  ...
  new_ctensorarray_ones_op(const Gdims& _adims,
                           const Gdims& _dims,
                           const int _nbu = -1,
                           const int _device = 0)
      : adims(_adims), dims(_dims), nbu(_nbu), device(_device) {}
  ...
  string str() const { return "ctensorarray_ones" + adims.str() + dims.str(); }
};
...
public:
  ...
  new_ctensorarray_identity_op(const Gdims& _adims, const Gdims& _dims, const
int _nbu=-1, const int _device=0): adims(_adims), dims(_dims), nbu(_nbu),
device(_device){
  }
...
class new_ctensorarray_sequential_op : public Coperator {
 public:
  ...
  new_ctensorarray_sequential_op(const Gdims& _adims,
                                 const Gdims& _dims,
                                 const int _nbu = -1,
                                 const int _device = 0)
      : adims(_adims), dims(_dims), nbu(_nbu), device(_device) {}
...
class new_ctensorarray_gaussian_op : public Coperator {
 public:
  ...
  new_ctensorarray_gaussian_op(const Gdims& _adims,
                               const Gdims& _dims,
                               const int _nbu = -1,
                               const int _device = 0)
      : adims(_adims), dims(_dims), nbu(_nbu), device(_device) {}
...
class ctensorarray_copy_op : public Coperator {
 public:
  ctensorarray_copy_op(Cnode* x) : Coperator(x) {}
  ...
  string str() const { return "ctensorarray_copy(" + inputs[0]->ident() + ")"; }
};
...
public:
  ...
  new_ctensorarray_fn2_op(const Gdims& _adims, const Gdims& _dims, const int
_nbu, function<complex<float>(const int, const int)> _fn, const int _dev=0):
...
public:
  ...
  ctensorarray_apply_op(Cnode* x, std::function<complex<float>(const
complex<float>)> _fn): Coperator(x), fn(_fn){}
...
public:
  ...
  ctensorarray_apply2_op(Cnode* x, std::function<complex<float>(const int, const
int, const complex<float>)> _fn): Coperator(x), fn(_fn){}
