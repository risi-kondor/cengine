...
namespace Cengine{
  ...
  public:
    ...
    virtual void exec(){
      assert(!owner->obj);
      owner->obj=new RscalarB(asRscalarB(inputs[0]));
      //owner->computed=true; 
    }
  ...
  public:
    ...
    virtual void exec(){
      ...
      asRscalarB(owner).add(asRscalarB(inputs[1]));
      //owner->computed=true; 
    }
  ...
  public:
    ...
    virtual void exec(){
      assert(!owner->obj);
      owner->obj=inputs[0]->obj;
      asRscalarB(owner).add(asRscalarB(inputs[1]),c);
      //owner->computed=true; 
    }
  ...
  public:
    ...
    virtual void exec(){
      assert(!owner->obj);
      owner->obj=inputs[0]->obj;
      asRscalarB(owner).subtract(asRscalarB(inputs[1]));
      //owner->computed=true; 
    }
  ...
  public:
    ...
    virtual void exec(){
      assert(!owner->obj);
      owner->obj=inputs[0]->obj;
      asRscalarB(owner).add_prod(asRscalarB(inputs[1]),asRscalarB(inputs[2]));
      //owner->computed=true; 
    }
  ...
  public:
    ...
    virtual void exec(){
      assert(!owner->obj);
      owner->obj=inputs[0]->obj;
      asRscalarB(owner).add_div(asRscalarB(inputs[1]),asRscalarB(inputs[2]));
      //owner->computed=true; 
    }
  ...
  public:
    ...
    virtual void exec(){
      assert(!owner->obj);
      owner->obj=inputs[0]->obj;
      asRscalarB(owner).add_div_back0(asRscalarB(inputs[1]),asRscalarB(inputs[2]));
      //owner->computed=true; 
    }
  ...
  public:
    ...
    virtual void exec(){
      assert(!owner->obj);
      owner->obj=inputs[0]->obj;
      asRscalarB(owner).add_div_back1(asRscalarB(inputs[1]),asRscalarB(inputs[2]),asRscalarB(inputs[3]));
      //owner->computed=true; 
    }
  ...
  public:
    ...
    virtual void exec(){
      assert(!owner->obj);
      owner->obj=inputs[0]->obj;
      asRscalarB(owner).add_pow(asRscalarB(inputs[1]),p,c);
      //owner->computed=true; 
    }
  ...
  public:
    ...
    virtual void exec(){
      assert(!owner->obj);
      owner->obj=inputs[0]->obj;
      asRscalarB(owner).add_exp(asRscalarB(inputs[1]));
      //owner->computed=true; 
    }
  ...
  public:
    ...
    virtual void exec(){
      assert(!owner->obj);
      owner->obj=inputs[0]->obj;
      asRscalarB(owner).add_abs(asRscalarB(inputs[1]));
      //owner->computed=true; 
    }
  ...
  public:
    ...
    virtual void exec(){
      assert(!owner->obj);
      owner->obj=inputs[0]->obj;
      asRscalarB(owner).add_abs_back(asRscalarB(inputs[1]),asRscalarB(inputs[2]));
      //owner->computed=true; 
    }
  ...
  public:
    ...
    virtual void exec(){
      assert(!owner->obj);
      owner->obj=inputs[0]->obj;
      asRscalarB(owner).add_ReLU(asRscalarB(inputs[1]),c);
      //owner->computed=true; 
    }
  ...
  public:
    ...
    virtual void exec(){
      assert(!owner->obj);
      owner->obj=inputs[0]->obj;
      asRscalarB(owner).add_ReLU_back(asRscalarB(inputs[1]),asRscalarB(inputs[2]),c);
      //owner->computed=true; 
    }
  ...
  public:
    ...
    virtual void exec(){
      assert(!owner->obj);
      owner->obj=inputs[0]->obj;
      asRscalarB(owner).add_sigmoid(asRscalarB(inputs[1]));
      //owner->computed=true; 
    }
  ...
  public:
    ...
    virtual void exec(){
      assert(!owner->obj);
      owner->obj=inputs[0]->obj;
      asRscalarB(owner).add_sigmoid_back(asRscalarB(inputs[1]),asRscalarB(inputs[2]));
      //owner->computed=true; 
    }
