...
class ctensor_add_op : public Coperator,
 ...
 public:
  string str() const { return "ctensor_add" + inp_str(); }

  static string classname() { return "ctensor_add_op"; }
  ...
  string batcher_name() const {
    return "ctensor_add<" + rsignature().str() + ">";
  }
  ...
  Rbatcher_base* spawn_rbatcher(BasicCnodeEngine* engine) const {
    return new MetaRbatcher<ctensor_add_op, ctensor_signature, Rbatcher>(
        engine);
  }
};

class ctensor_add_prod_c_A_op : public Coperator,
                                public CumulativeOperator,
                                public InPlaceOperator,
                                public RbatchedOperator {
 public:
 ...
 public:
  ...
  static string classname() { return "ctensor_add_prod_c_A_op"; }
  ...
  */
  ...
  int rbatcher_id() const { return _rbatcher_id; }
  string rbatcher_name() const {
    return "ctensor_add_prod_c_A<" + rsignature().str() + ">";
  }
  ctensor_signature rsignature() const { return ctensor_signature(dims); }
